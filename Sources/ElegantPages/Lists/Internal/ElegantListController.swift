...
class HideNavigationBarHostingController<Content>: UIHostingController<AnyView> where Content : View {
...
class ElegantTriadPagesController: UIViewController {
    ...
    private var controllers: [HideNavigationBarHostingController<AnyView>]
    ...
    init(manager: ElegantListManager,
        ...
        controllers = manager.pageRange.map { page in
            HideNavigationBarHostingController(rootView: viewForPage(page))
        }
